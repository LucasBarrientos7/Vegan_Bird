...
public class Tubo {
	...
	/** Este m�todo se encarga de disminuir la x de la imagen del tubo, dando una sensaci�n 
	...
	/** Este m�todo consiste en graficar los tubos en la parte superior de la pantalla. 
	 * 
	 */
	...
	/** Este m�todo consiste en graficar los tubos en la parte inferior de la pantalla 
	 * 
	 */
